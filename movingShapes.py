...
while(1):
    ...
    if (count<10):
        cv2.imwrite(output_filepath+"/image-0000"+str(count)+".jpg", resized_background)
    elif (count<100):
        cv2.imwrite(output_filepath+"/image-000"+str(count)+".jpg", resized_background)
    elif (count<1000):
        cv2.imwrite(output_filepath+"/image-00"+str(count)+".jpg", resized_background)
    elif (count<10000):
        cv2.imwrite(output_filepath+"/image-0"+str(count)+".jpg", resized_background)
    else:
        cv2.imwrite(output_filepath+"/image-"+str(count)+".jpg", resized_background)
