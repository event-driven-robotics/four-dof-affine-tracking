...
do
   ...
   echo $n_videos
   touch ~/shared/data/new_background/videos_open_loop/$shape/trans_x_open_loop_moving_background/list.txt
   num=$(( $n_videos + 1 )) 
   cd ~/shared/data/new_background/videos_open_loop/$shape/trans_x_open_loop_moving_background/
   exec 3>list.txt
   for ((i=1;i<=$num;i++)) 
   do
   ...
   if [ "$n_videos" -ne "0" ]; then
       ffmpeg -f concat -safe 0 -i list.txt -c copy ~/shared/data/new_background/videos_open_loop/$shape/trans_x_open_loop_moving_background/"output_${s}_300Hz_merged.mp4"
   fi
   sleep 1
done
...
do
   ...
   echo $n_videos
   touch ~/shared/data/new_background/videos_open_loop/$shape/trans_y_open_loop_moving_background/list.txt
   num=$(( $n_videos + 1 )) 
   cd ~/shared/data/new_background/videos_open_loop/$shape/trans_y_open_loop_moving_background/
   exec 3>list.txt
   for ((i=1;i<=$num;i++)) 
   do
       echo file "output_${s}_300Hz.mp4" >&3
   ...
   if [ "$n_videos" -ne "0" ]; then
       ffmpeg -f concat -safe 0 -i list.txt -c copy ~/shared/data/new_background/videos_open_loop/$shape/trans_y_open_loop_moving_background/"output_${s}_300Hz_merged.mp4"
       exit; 
   fi
done
...
do
   ...
   echo $n_videos
   touch ~/shared/data/new_background/videos_open_loop/$shape/sc_open_loop_moving_background/list.txt
   num=$(( $n_videos + 1 )) 
   cd ~/shared/data/new_background/videos_open_loop/$shape/sc_open_loop_moving_background/
   exec 3>list.txt
   for ((i=1;i<=$num;i++)) 
   do
       echo file "output_${s}_300Hz.mp4" >&3
   ...
   if [ "$n_videos" -ne "0" ]; then
       ffmpeg -f concat -safe 0 -i list.txt -c copy ~/shared/data/new_background/videos_open_loop/$shape/sc_open_loop_moving_background/"output_${s}_300Hz_merged.mp4"
       exit; 
   fi
done
...
do
   ...
   echo $n_videos
   touch ~/shared/data/new_background/videos_open_loop/$shape/rot_open_loop_moving_background/list.txt
   num=$(( $n_videos + 1 )) 
   cd ~/shared/data/new_background/videos_open_loop/$shape/rot_open_loop_moving_background/
   exec 3>list.txt
   for ((i=1;i<=$num;i++)) 
   do
       echo file "output_${s}_300Hz.mp4" >&3
   ...
   if [ "$n_videos" -ne "0" ]; then
       ffmpeg -f concat -safe 0 -i list.txt -c copy ~/shared/data/new_background/videos_open_loop/$shape/rot_open_loop_moving_background/"output_${s}_300Hz_merged.mp4"
       exit; 
   fi
done
...
do
   ...
   echo $n_videos
   touch ~/shared/data/new_background/videos_open_loop/$shape/4dof_open_loop_moving_background/list.txt
   num=$(( $n_videos + 1 )) 
   cd ~/shared/data/new_background/videos_open_loop/$shape/4dof_open_loop_moving_background/
   exec 3>list.txt
   for ((i=1;i<=$num;i++)) 
   do
       echo file "output_${s}_300Hz.mp4" >&3
   ...
   if [ "$n_videos" -ne "0" ]; then
       ffmpeg -f concat -safe 0 -i list.txt -c copy ~/shared/data/new_background/videos_open_loop/$shape/4dof_open_loop_moving_background/"output_${s}_300Hz_merged.mp4"
       exit; 
   fi
done
