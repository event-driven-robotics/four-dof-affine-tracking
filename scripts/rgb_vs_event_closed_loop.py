...
plt.plot(speeds[0:3], rgb_mean_errors_target_speed[0:3], linestyle='-', color='tab:orange', label='real-sense')
plt.fill_between(speeds[0:3], diff_rgb_std, sum_rgb_std, alpha=0.2, color="tab:orange")
plt.plot(speeds, event_mean_errors_target_speed, linestyle='-', label='event-camera')
plt.fill_between(speeds, diff_event_std, sum_event_std, alpha=0.2, color="tab:blue")
plt.plot(speeds, event_mean_errors_target_speed_open_loop, color='tab:blue',linestyle='--', alpha = 0.5)
plt.plot(speeds, rgb_mean_errors_target_speed_open_loop, color='tab:orange', linestyle='--', alpha = 0.5)
plt.scatter(2,rgb_mean_errors_target_speed[2], s=100,marker='x',color='tab:orange',linewidths=2)
...
ax1[1].set_xlim([0, 10])
ax1[2].set_xlim([0, 10])
ax1[0].legend(bbox_to_anchor=(0.12, 1.02, 0, 0.2), loc='lower left', ncol=2)
ax2.legend(bbox_to_anchor=(0.61, 1.02, 0, 0.2), loc='lower left', ncol=1)
